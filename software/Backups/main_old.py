        ...
        while True:
            ...
            if state == "findball":
                ...
                try:
                    ...
                    if temptimer >= 170: # 140
                            state = "findball"
                    if temptimer >= 90: # 50
                        print("f")
                        robot.makeshot(ibasket.distance, ibasket.x, 2)
                    if temptimer >= 30 and temptimer < 80: # 50
                        robot.makeshot(ibasket.distance, ibasket.x, 1)
                    temptimer += 1
                except:
                ...
                try:
                    try:
                        speed_x = -robot.controller(ibasket.x, middle_x, x_scale=1500, y_scale=(max_speed - 3))
                    except:
                        print("No basket")
                        speed_x=max_speed 
