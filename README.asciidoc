...
15th December --- 9h KarlR tried working with the PCB and coded some firmware. KarlV and Matis were working on the code, Nikita was making solder fixes for the PCB.
