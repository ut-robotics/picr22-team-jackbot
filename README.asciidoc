...
26.sept 
3h assembled the thrower ramp, made some fixes
...
27.okt Tested throwing balls from a ramp. Code needs some additional time before being test ready. aprox 6h of coding time needed for an semi working code.
